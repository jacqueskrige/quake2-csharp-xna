...
technique TexturedSkin
{
	pass Pass0
	{   
		VertexShader = compile vs_2_0 TexturedSkinVS();
		PixelShader  = compile ps_2_0 TexturedSkinPS();
	}
}
...
technique TexturedLightmap
{
	...
	{   
		VertexShader = compile vs_2_0 TexturedVS();
		PixelShader  = compile ps_2_0 TexturedLightmapPS();
	}
}
...
technique TexturedWarped
{
	pass Pass0
	{   
		VertexShader = compile vs_2_0 TexturedWarpedVS();
		PixelShader  = compile ps_2_0 TexturedPS();
	}
}
...
technique TexturedTranslucent
{
	pass Pass0
	{
		...
		VertexShader = compile vs_2_0 TexturedVS();
		PixelShader  = compile ps_2_0 TexturedTranslucentPS();
	}
}
...
technique TexturedSkybox
{
	pass Pass0
	{
		VertexShader = compile vs_2_0 TexturedSkyboxVS();
		PixelShader  = compile ps_2_0 TexturedSkyboxPS();
	}
}
...
technique TexturedLight
{
	pass Pass0
	{   
		VertexShader = compile vs_2_0 TexturedLightVS();
		PixelShader  = compile ps_2_0 TexturedLightPS();
	}
}
...
technique BloomExtract
{
	pass Pass0
	{
		PixelShader  = compile ps_2_0 BloomExtractPS();
	}
}
...
technique BloomCombine
{
	pass Pass0
	{
		PixelShader  = compile ps_2_0 BloomCombinePS();
	}
}
